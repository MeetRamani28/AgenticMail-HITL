  ...
  return (
    <nav className="bg-slate-900 text-white px-6 py-4 flex justify-between items-center shadow-md border-b border-slate-800">
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-xs text-slate-400">
            Enterprise Email Operations Agent
          </p>
        </div>
      </div>
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center space-x-1 text-xs bg-indigo-950 text-indigo-300 px-3 py-1.5 rounded-full border border-indigo-800">
          <ShieldCheck className="w-4 h-4 text-indigo-400" />
          <span>HITL Verification Enabled</span>
        </div>
      </div>
    </nav>
  );
